...
| id | title | status | PR |
|---|---|---|---|
| t01-scaffold | Repo skeleton, CI, Pages deploy | todo | |
| t02-domain | Pure domain layer | todo | |
| t03-world | The 3D world from a WorldModel | todo | |
| t04-supabase | Schema, RLS, data layer | todo | |
